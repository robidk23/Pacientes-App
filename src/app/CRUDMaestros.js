        ...
        Datos.forEach(documento => {
            ...
            const li = `
                <li class="list-group-item list-group-item-action">
                    ...
                    <button class="btn btn-outline-warning w-100 mb-2 botoneSinSesion Eliminar-Paciente" data-id="${idDocumento}"> Eliminar </button>
                    <button class="btn btn-outline-success w-100 mb-2 botoneSinSesion Actualizar-Paciente" data-id="${idDocumento}" data-bs-toggle="modal" data-bs-target="#ActualizarPaciente"> Actualizar </button>
                </li>
            `;
            html += li;
        });
